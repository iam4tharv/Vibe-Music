...
-keepclassmembers class com.music.echo.utils.sabr.EjsNTransformSolver$SolverWebView {
    @android.webkit.JavascriptInterface public *;
}
-keepclassmembers class com.music.echo.utils.cipher.CipherWebView {
    @android.webkit.JavascriptInterface public *;
}
-keepclassmembers class com.music.echo.utils.potoken.PoTokenWebView {
    @android.webkit.JavascriptInterface public *;
}

# Keep streaming utility classes
-keep class com.music.echo.utils.cipher.** { *; }
-keep class com.music.echo.utils.sabr.** { *; }
-keep class com.music.echo.utils.potoken.** { *; }
...
-keep class com.music.echo.models.PersistQueue { *; }
-keep class com.music.echo.models.PersistPlayerState { *; }
-keep class com.music.echo.models.QueueData { *; }
-keep class com.music.echo.models.QueueType { *; }
-keep class com.music.echo.playback.queues.** { *; }
...
## Google Cast Rules
-keep class com.music.echo.cast.** { *; }
...
-keep class com.music.echo.recognition.VibraSignature { *; }
-keepclassmembers class com.music.echo.recognition.VibraSignature {
    native <methods>;
}
