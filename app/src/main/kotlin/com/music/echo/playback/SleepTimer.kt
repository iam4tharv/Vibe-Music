...
class SleepTimer(
    ...
    var pauseWhenSongEnd by mutableStateOf(false)
        private set
    var isWaitingForTrackEnd by mutableStateOf(false)
        private set
    val isActive: Boolean
        get() = triggerTime != -1L || pauseWhenSongEnd || isWaitingForTrackEnd

    fun start(minute: Int, waitEndTrack: Boolean = false) {
