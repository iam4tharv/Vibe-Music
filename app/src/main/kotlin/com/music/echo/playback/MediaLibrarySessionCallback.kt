...
import com.music.echo.constants.MediaSessionConstants
...
constructor(
    ...
    override fun onGetChildren(
        ...
        scope.future(Dispatchers.IO) {
            val children =
                when (parentId) {
                    MusicService.ROOT -> libraryChildren()
    ...
    private fun com.music.echo.db.entities.Playlist.toBrowsableMediaItem() = browsableMediaItem(
    ...
    private fun Song.toMediaItem(path: String, isPlayable: Boolean = true, isBrowsable: Boolean = false): MediaItem {
        val baseSubtitle = artists.joinToString { it.name }
