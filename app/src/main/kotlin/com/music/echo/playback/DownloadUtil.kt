...
import com.music.echo.utils.enumPreference
...
constructor(
    ...
    private val downloadQuality by enumPreference(context, com.music.echo.constants.DownloadQualityKey, com.music.echo.constants.DownloadQuality.YOUTUBE)
            ...
            val playbackData = runBlocking(Dispatchers.IO) {
                YTPlayerUtils.playerResponseForPlayback(
                    ...
                    audioQuality = when (downloadQuality) {
                        com.music.echo.constants.DownloadQuality.JIOSAAVN -> AudioQuality.JIOSAAVN
