...
import com.music.echo.constants.DiscordActivityButton1CustomUrlKey
import com.music.echo.constants.DiscordActivityButton1EnabledKey
import com.music.echo.constants.DiscordActivityButton1LabelKey
import com.music.echo.constants.DiscordActivityButton1UrlSourceKey
import com.music.echo.constants.DiscordActivityButton2CustomUrlKey
import com.music.echo.constants.DiscordActivityButton2EnabledKey
import com.music.echo.constants.DiscordActivityButton2LabelKey
import com.music.echo.constants.DiscordActivityButton2UrlSourceKey
import com.music.echo.constants.DiscordActivityDetailsKey
import com.music.echo.constants.DiscordActivityNameKey
import com.music.echo.constants.DiscordActivityPlatformKey
import com.music.echo.constants.DiscordActivityStateKey
import com.music.echo.constants.DiscordActivityTypeKey
import com.music.echo.constants.DiscordLargeImageCustomUrlKey
import com.music.echo.constants.DiscordLargeImageTypeKey

import com.music.echo.constants.DiscordPresenceStatusKey
import com.music.echo.constants.DiscordShowWhenPausedKey
import com.music.echo.constants.DiscordSmallImageCustomUrlKey
import com.music.echo.constants.DiscordSmallImageTypeKey
import com.music.echo.constants.DiscordSmallImageTypeKey
...
class DiscordRPC(
    ...
    private suspend fun resolveButtons(song: Song): List<DiscordPresenceButton> {
        ...
        val button2Label = context.dataStore[DiscordActivityButton2LabelKey] ?: "Go to Vibe Music"
        ...
        val button2CustomUrl =
            context.dataStore[DiscordActivityButton2CustomUrlKey]
                ?: "https://github.com/iam4tharv/Vibe-Music"
