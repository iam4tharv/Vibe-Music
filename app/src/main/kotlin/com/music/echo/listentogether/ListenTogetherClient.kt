...
import com.music.echo.constants.ListenTogetherAutoApprovalKey
import com.music.echo.constants.ListenTogetherIsHostKey
import com.music.echo.constants.ListenTogetherRoomCodeKey
import com.music.echo.constants.ListenTogetherServerUrlKey
import com.music.echo.constants.ListenTogetherSessionTimestampKey
import com.music.echo.constants.ListenTogetherSessionTokenKey
import com.music.echo.constants.ListenTogetherUserIdKey
...
class ListenTogetherClient @Inject constructor(
    ...
    companion object {
        ...
        const val ACTION_APPROVE_JOIN = "com.music.echo.LISTEN_TOGETHER_APPROVE_JOIN"
        const val ACTION_REJECT_JOIN = "com.music.echo.LISTEN_TOGETHER_REJECT_JOIN"
        const val ACTION_APPROVE_SUGGESTION = "com.music.echo.LISTEN_TOGETHER_APPROVE_SUGGESTION"
        const val ACTION_REJECT_SUGGESTION = "com.music.echo.LISTEN_TOGETHER_REJECT_SUGGESTION"
    ...
    private fun loadBlockedUsernames() {
        try {
            val blockedJson = context.dataStore.get(com.music.echo.constants.ListenTogetherBlockedUsersKey, "")
    ...
    private suspend fun saveBlockedUsernames() {
        try {
            ...
            context.dataStore.edit { preferences ->
                preferences[com.music.echo.constants.ListenTogetherBlockedUsersKey] = blockedJson
            }
        } catch (e: Exception) {
