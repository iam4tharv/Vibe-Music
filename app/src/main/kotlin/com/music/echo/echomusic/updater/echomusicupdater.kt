...
package com.music.echo.echomusic.updater
...
import com.music.echo.echomusic.updater.downloadmanager.UpdateDownloadWorker
import com.music.echo.echomusic.updater.downloadmanager.DownloadNotificationManager
...
import com.music.echo.ui.component.ChangelogItem
import com.music.echo.ui.component.leadingItemShape
import com.music.echo.ui.component.middleItemShape
import com.music.echo.ui.component.endItemShape
import com.music.echo.ui.component.detachedItemShape
import com.music.echo.ui.component.parseMarkdown
import com.music.echo.ui.component.endItemShape
import com.music.echo.ui.component.detachedItemShape
import com.music.echo.ui.component.AnimatedActionButton
import com.music.echo.ui.component.ExpressiveIconButton
import com.music.echo.ui.component.ErrorSnackbar
                                ...
                                AnimatedActionButton(
                                    ...
                                    onClick = {
                                        if (isDownloadComplete) {
                                            ...
                                            val urlToDownload = currentStatus.apkUrl ?: "https://github.com/iam4tharv/Vibe-Music/releases/download/${currentStatus.version}/vibemusic.apk"
...
suspend fun checkForUpdate(
    ...
    withContext(Dispatchers.IO) {
        try {
            val url = URL("https://api.github.com/repos/iam4tharv/Vibe-Music/releases/latest")
            ...
            if (shouldShow) {
                ...
                try {
                    val changelogUrl =
                        URL("https://github.com/iam4tharv/Vibe-Music/releases/download/$tagWithPrefix/changelog.json")
