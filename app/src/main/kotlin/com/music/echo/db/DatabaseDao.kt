...
import com.music.echo.db.entities.AlbumArtistMap
import com.music.echo.db.entities.AlbumEntity
import com.music.echo.db.entities.AlbumWithSongs
...
import com.music.echo.db.entities.RecognitionHistory
import com.music.echo.db.entities.RelatedSongMap
import com.music.echo.db.entities.SearchHistory
import com.music.echo.db.entities.SetVideoIdEntity
import com.music.echo.db.entities.Song
import com.music.echo.db.entities.SongAlbumMap
import com.music.echo.db.entities.SongArtistMap
import com.music.echo.db.entities.SongEntity
import com.music.echo.db.entities.SongWithStats
import com.music.echo.extensions.reversed
import com.music.echo.extensions.toSQLiteQuery
import com.music.echo.models.MediaMetadata
import com.music.echo.models.toMediaMetadata
import com.music.echo.ui.utils.resize
...
interface DatabaseDao {
    ...
    @Query("SELECT * FROM song") fun getAllSongs(): List<com.music.echo.db.entities.SongEntity>
    @Insert(onConflict = OnConflictStrategy.REPLACE) fun insertSongs(items: List<com.music.echo.db.entities.SongEntity>)

    @Query("SELECT * FROM artist") fun getAllArtists(): List<com.music.echo.db.entities.ArtistEntity>
    @Insert(onConflict = OnConflictStrategy.REPLACE) fun insertArtists(items: List<com.music.echo.db.entities.ArtistEntity>)

    @Query("SELECT * FROM album") fun getAllAlbums(): List<com.music.echo.db.entities.AlbumEntity>
    @Insert(onConflict = OnConflictStrategy.REPLACE) fun insertAlbums(items: List<com.music.echo.db.entities.AlbumEntity>)

    @Query("SELECT * FROM playlist") fun getAllPlaylists(): List<com.music.echo.db.entities.PlaylistEntity>
    @Insert(onConflict = OnConflictStrategy.REPLACE) fun insertPlaylists(items: List<com.music.echo.db.entities.PlaylistEntity>)

    @Query("SELECT * FROM playlist_song_map") fun getAllPlaylistSongMaps(): List<com.music.echo.db.entities.PlaylistSongMap>
    @Insert(onConflict = OnConflictStrategy.REPLACE) fun insertPlaylistSongMaps(items: List<com.music.echo.db.entities.PlaylistSongMap>)

    @Query("SELECT * FROM song_artist_map") fun getAllSongArtistMaps(): List<com.music.echo.db.entities.SongArtistMap>
    @Insert(onConflict = OnConflictStrategy.REPLACE) fun insertSongArtistMaps(items: List<com.music.echo.db.entities.SongArtistMap>)

    @Query("SELECT * FROM song_album_map") fun getAllSongAlbumMaps(): List<com.music.echo.db.entities.SongAlbumMap>
    @Insert(onConflict = OnConflictStrategy.REPLACE) fun insertSongAlbumMaps(items: List<com.music.echo.db.entities.SongAlbumMap>)

    @Query("SELECT * FROM album_artist_map") fun getAllAlbumArtistMaps(): List<com.music.echo.db.entities.AlbumArtistMap>
    @Insert(onConflict = OnConflictStrategy.REPLACE) fun insertAlbumArtistMaps(items: List<com.music.echo.db.entities.AlbumArtistMap>)

    @Query("SELECT * FROM search_history") fun getAllSearchHistory(): List<com.music.echo.db.entities.SearchHistory>
    @Insert(onConflict = OnConflictStrategy.REPLACE) fun insertSearchHistory(items: List<com.music.echo.db.entities.SearchHistory>)

    @Query("SELECT * FROM event") fun getAllEvents(): List<com.music.echo.db.entities.Event>
    @Insert(onConflict = OnConflictStrategy.REPLACE) fun insertEvents(items: List<com.music.echo.db.entities.Event>)
    
    @Query("DELETE FROM song") fun deleteAllSongs()
    @Query("DELETE FROM artist") fun deleteAllArtists()
    @Query("DELETE FROM album") fun deleteAllAlbums()
    @Query("DELETE FROM playlist") fun deleteAllPlaylists()
    @Query("DELETE FROM search_history") fun deleteAllSearchHistory()
    @Query("DELETE FROM event") fun deleteAllEvents()

    @Query("DELETE FROM playlist_song_map") fun deleteAllPlaylistSongMaps()
