...
import com.music.echo.recognition.MusicRecognitionService
...
import com.music.echo.widget.MusicRecognizerWidgetService.Companion.STATE_ERROR
import com.music.echo.widget.MusicRecognizerWidgetService.Companion.STATE_IDLE
import com.music.echo.widget.MusicRecognizerWidgetService.Companion.STATE_LISTENING
import com.music.echo.widget.MusicRecognizerWidgetService.Companion.STATE_NO_MATCH
import com.music.echo.widget.MusicRecognizerWidgetService.Companion.STATE_PROCESSING
import com.music.echo.widget.MusicRecognizerWidgetService.Companion.STATE_SUCCESS
import java.io.File
        ...
        if (!MusicRecognitionService.hasRecordPermission(context)) {
            context.startActivity(
                Intent(context, MainActivity::class.java).apply {
                    action = "com.music.echo.action.RECOGNITION"
