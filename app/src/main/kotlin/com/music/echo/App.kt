...
import com.music.echo.di.ApplicationScope
import com.music.echo.extensions.toEnum
import com.music.echo.extensions.toInetSocketAddress
import com.music.echo.utils.CrashHandler
...
class App : Application(), SingletonImageLoader.Factory {
    ...
    private suspend fun initializeSettings() {
        ...
        val currentAudioQuality = settings[AudioQualityKey]?.toEnum(defaultValue = AudioQuality.JIOSAAVN) ?: AudioQuality.JIOSAAVN
        ...
        return ImageLoader.Builder(this).apply {
            ...
            memoryCache {
                MemoryCache.Builder()
                    ...
                    // Custom strategy to prevent OOMs during rapid scrolling:
                    // Lowered strong memory cache size to 10% of available memory,
                    // relying on weak references to maintain cached album art
                    // that is still in use by the UI.
