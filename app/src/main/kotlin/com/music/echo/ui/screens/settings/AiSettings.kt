...
import com.music.echo.constants.HeyVibeeEnabledKey
...
highlightKey: String? = null) {
    ...
    isHighlighted = (highlightKey == stringResource(R.string.ai_auto_translate)),
        ...
        Material3SettingsGroup(
            title = stringResource(R.string.ai_vibee),
            items = buildList {
                add(
                    Material3SettingsItem(
                        isHighlighted = (highlightKey == stringResource(R.string.ai_hey_vibee)),
                        icon = painterResource(R.drawable.mic),
                        title = { Text(stringResource(R.string.ai_hey_vibee)) },
                        description = { Text(stringResource(R.string.ai_hey_vibee_desc)) },
                        trailingContent = {
                            Switch(
        ...
        if (showRefreshDialog) {
            com.music.echo.ui.component.RefreshAiRecommendationDialog(
