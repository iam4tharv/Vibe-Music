                ...
                items = buildList {
                    add(
                        Material3MenuItemData(
                            customComposable = {
                                com.music.echo.ui.component.CastButton(asMenuItem = true)
                            }
                        )
                    )
                    ...
                    add(
                        Material3MenuItemData(
                            ...
                            onClick = {
                                ...
                                androidx.media3.exoplayer.offline.DownloadService.sendRemoveDownload(context, com.music.echo.playback.ExoDownloadService::class.java, mediaMetadata.id, false)
