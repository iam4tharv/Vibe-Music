...
import com.music.echo.constants.HistorySource
...
import com.music.echo.viewmodels.DateAgo
import com.music.echo.viewmodels.HistoryViewModel
            ...
            onClick = {
                if (historySource == HistorySource.REMOTE && historyPage != null) {
                    ...
                    playerConnection.playQueue(shuffle = true, queue = 
                        ListQueue(
                            title = context.getString(R.string.history),
                            items = allEvents.map { it.song.toMediaItem() }
                        )
                    )
                }
            }
