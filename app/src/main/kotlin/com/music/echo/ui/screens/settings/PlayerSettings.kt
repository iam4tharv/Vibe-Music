...
import com.music.echo.constants.EnableGoogleCastKey
...
import com.music.echo.constants.SeekExtraSeconds
import com.music.echo.constants.ShufflePlaylistFirstKey
import com.music.echo.constants.SimilarContent
import com.music.echo.constants.ShowAudioFallbackToastKey
...
import com.music.echo.constants.EnableExportAsMp3Key
...
highlightKey: String? = null) {
    ...
    val (shakeToPlayNext, onShakeToPlayNextChange) = rememberPreference(
        com.music.echo.constants.ShakeToPlayNextKey,
        defaultValue = false
    )
    ...
    val (dataSaver, onDataSaverChange) = rememberPreference(
        com.music.echo.constants.DataSaverKey,
        defaultValue = false
    )

    val (_, onPlayerBackgroundStyleChange) = rememberEnumPreference(
        com.music.echo.constants.PlayerBackgroundStyleKey,
        defaultValue = com.music.echo.constants.PlayerBackgroundStyle.DEFAULT
    )
    ...
    val (downloadQuality, onDownloadQualityChange) = rememberEnumPreference(
        com.music.echo.constants.DownloadQualityKey,
        defaultValue = com.music.echo.constants.DownloadQuality.YOUTUBE
    )
    ...
    if (showDownloadQualityDialog) {
        EnumDialog(
            ...
            values = listOf(com.music.echo.constants.DownloadQuality.YOUTUBE, com.music.echo.constants.DownloadQuality.JIOSAAVN),
            valueText = {
                when (it) {
                    com.music.echo.constants.DownloadQuality.YOUTUBE -> "YouTube Music (AAC/Default)"
                    com.music.echo.constants.DownloadQuality.JIOSAAVN -> "JioSaavn (320 kbps)"
                }
            }
        )
    }
        ...
        Material3SettingsGroup(scrollState = scrollState, 
            ...
            items = buildList {
                add(Material3SettingsItem(
                    ...
                    onClick = {
                        val newValue = !dataSaver
                        onDataSaverChange(newValue)
                        if (newValue) {
                            onAudioQualityChange(AudioQuality.OPUS)
                            onPlayerBackgroundStyleChange(com.music.echo.constants.PlayerBackgroundStyle.LIQUID_GLASS)
                                } else {
    ...
    isHighlighted = (highlightKey == stringResource(R.string.audio_offload)),
                ...
                add(Material3SettingsItem(
                    ...
                    trailingContent = {
                        Switch(
                            checked = shakeToPlayNext,
                            onCheckedChange = onShakeToPlayNextChange,
                            thumbContent = {
                                Icon(
                                    painter = painterResource(
                    ...
                    onClick = { onShakeToPlayNextChange(!shakeToPlayNext) }
                ))
    ...
    isHighlighted = (highlightKey == stringResource(R.string.export_desc)),
                ...
                Material3SettingsItem(
                    ...
                    onClick = { navController.navigate("settings/vibe_extractor") }
                )
            )
        )
