...
highlightKey: String? = null) {
    ...
    val isUpdateAvailable = getUpdateAvailableState(context) && com.music.echo.echomusic.updater.getAutoUpdateCheckSetting(context)
    ...
    isHighlighted = (highlightKey == accountText),
            ...
            if (donateText.lowercase().contains(searchLower)) {
                add(
                    Material3SettingsItem(
                        isHighlighted = (highlightKey == donateText),
                        icon = painterResource(R.drawable.favorite),
                        title = { Text(donateText) },
                        onClick = { navController.navigate("settings/donate") }
                    )
                )
            }
    ...
    isHighlighted = (highlightKey == systemUpdateText),
                        icon = painterResource(if (isUpdateAvailable) R.drawable.music_note else R.drawable.update),
