...
import com.music.echo.echomusic.component.UpdateInfoDialog
import com.music.echo.ui.utils.backToMain
import com.music.echo.echomusic.updater.getAutoUpdateCheckSetting
import com.music.echo.echomusic.updater.saveAutoUpdateCheckSetting
import com.music.echo.echomusic.updater.getUpdateAvailableState
...
import com.music.echo.echomusic.updater.saveUpdateNotificationsSetting
import android.widget.Toast
import androidx.compose.ui.res.pluralStringResource
import com.music.echo.echomusic.updater.getDownloadedApkCount
import com.music.echo.echomusic.updater.clearDownloadedApks
import com.music.echo.echomusic.updater.getBetaUpdatesSetting
import com.music.echo.echomusic.updater.saveBetaUpdatesSetting
import com.music.echo.echomusic.updater.autoClearOldApks
...
fun UpdateSettings(
    ...
    isHighlighted = (highlightKey == stringResource(R.string.system_update)),
                    ...
                    onClick = {
                        ...
                        if (isFoss) {
                            val intent = Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/iam4tharv/Vibe-Music"))
