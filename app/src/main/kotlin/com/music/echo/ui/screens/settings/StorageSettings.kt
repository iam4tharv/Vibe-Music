...
import com.music.echo.constants.MaxImageCacheSizeKey
...
import com.music.echo.ui.utils.formatFileSize
        ...
        ActionPromptDialog(
            ...
            onConfirm = {
                androidx.media3.exoplayer.offline.DownloadService.sendRemoveAllDownloads(
                    context,
                    com.music.echo.playback.ExoDownloadService::class.java,
                    false
                )
