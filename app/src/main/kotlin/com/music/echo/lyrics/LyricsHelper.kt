...
import com.music.echo.constants.PreferredLyricsProvider
import com.music.echo.constants.PreferredLyricsProviderKey
...
constructor(
    ...
    suspend fun getLyrics(mediaMetadata: MediaMetadata): LyricsWithProvider {
        ...
        return providers.asFlow().mapNotNull { provider ->
            try {
                ...
                if (result != null && result != LYRICS_NOT_FOUND && result.isNotBlank()) {
                    ...
                    val lyricsWithProvider = LyricsWithProvider(result, provider.name)
                    if (isSynced) {
                        lyricsWithProvider
                    } else {
                        if (bestUnsynced == null) {
                            bestUnsynced = lyricsWithProvider
                        }
                        null
                    }
                } else {
